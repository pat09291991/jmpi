...
<body class="font-['Poppins']">
        ...
        >
          ...
          <div class="flex flex-col flex-1 p-6 text-left">
            ...
            <div class="flex justify-end mt-auto">
              <button class="px-6 py-2 bg-[#F01B23] text-white rounded-full font-bold text-sm hover:bg-[#F01B23] transition">
                VIEW
              </button>
            </div>
          </div>
  ...
  <div id="product-modal" class="fixed inset-0 bg-[#252525] bg-opacity-60 flex items-center justify-center z-50 hidden px-4 md:px-0">
    <div class="bg-white rounded-2xl shadow-lg w-full lg:max-w-4xl p-0 relative flex flex-col md:flex-row overflow-hidden max-h-[90vh]">
      ...
      <button id="close-modal" class="modal-close absolute top-2 right-2 text-2xl text-gray-400 hover:text-[#F01B23]">&times;</button>
    </div>
  </div>
  <script>
