...
<?php include 'header.php'; ?>
          ...
          <?php foreach ($productsList as $product): ?>
            <div class="swiper-slide bg-white rounded-3xl shadow w-56 lg:w-64 overflow-hidden group relative transition-all duration-300 ">
              ...
              <div class="p-4 flex flex-col items-center text-center min-h-40 bg-gray-100">
                ...
                <button class="px-6 py-2 bg-[#F01B23] text-white rounded-full font-bold text-xs md:text-sm lg:text-base top-product-view-btn" data-product-id="<?= htmlspecialchars($product['id']) ?>">VIEW</button>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
  ...
  <section class="w-full flex flex-col lg:flex-row items-center justify-center md:gap-12 px-4 md:px-8 py-8 md:py-12 lg:py-16 mt-8" data-aos="fade-up" data-aos-delay="200">
    ...
    <div class="w-full lg:w-1/2 flex justify-center items-stretch mb-8 lg:mb-0" data-aos="fade-down" data-aos-delay="200">
      <div class="relative w-full max-w-2xl md:max-w-2xl lg:max-w-3xl aspect-video rounded-3xl overflow-hidden shadow-lg flex-shrink-0 bg-[#F01B23]">
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center text-center h-full" data-aos="fade-up" data-aos-delay="300">
      ...
      <a href="/stores.php" class="px-8 py-3 bg-[#F01B23] text-white rounded-full font-bold text-xs md:text-sm lg:text-base shadow hover:bg-[#F01B23] transition">SEE ALL LOCATIONS</a>
    </div>
  </section>
  ...
  <section class="w-full flex flex-col lg:flex-row items-center justify-center gap-12 py-8 md:py-12 lg:py-16 mt-8 bg-gray-100">
    ...
    <div class="w-full lg:w-1/2 flex justify-center items-stretch mb-8 lg:mb-0 px-4 md:px-8" data-aos="fade-down" data-aos-delay="400">
      <div class="relative w-full max-w-xl md:max-w-2xl lg:max-w-3xl aspect-video rounded-3xl overflow-hidden shadow-lg flex-shrink-0 group">
        ...
        <div class="absolute inset-0 bg-[#F01B23] bg-opacity-90 flex items-center justify-center transition-opacity duration-300 group-hover:opacity-0">
  ...
  <section class="w-full bg-gray-50 py-20 px-20" data-aos="fade-up" data-aos-delay="150">
    <div class="mx-auto">
      <h2 class="text-lg sm:text-2xl md:text-4xl font-extrabold text-[#F01B23] text-center mb-2">JMPi Service Strengths</h2>
        ...
        <?php foreach ($service_strengths as $strength): ?>
          <div class="flex flex-col items-center text-center px-4 group" data-aos="fade-up" data-aos-delay="<?= 200 + ($i * 200) ?>">
            ...
            <?php elseif ($strength['icon'] === 'credit-card'): ?>
              <svg class="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-4 text-gray-400 group-hover:text-[#F01B23]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M2 10h20"/></svg>
            <?php elseif ($strength['icon'] === 'percent'): ?>
              <svg class="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-4 text-gray-400 group-hover:text-[#F01B23]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="19" y1="5" x2="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>
            <?php endif; ?>
            <h3 class="font-bold text-base sm:text-lg md:text-xl mb-2 text-[#252525]"><?= htmlspecialchars($strength['title']) ?></h3>
            <p class="text-xs sm:text-sm md:text-base text-[#252525] text-base"><?= htmlspecialchars($strength['description']) ?></p>
          </div>
          <?php $i++; ?>
        <?php endforeach; ?>
      </div>
