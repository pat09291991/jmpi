...
<body class="bg-white font-['Poppins']">
  ...
  <section class="w-full flex flex-col justify-between xl:flex-row lg:gap-32 px-4 md:px-24 py-8 md:py-12 lg:py-16"
    ...
    <!-- New Product Column -->
    <div
      class="w-full xl:w-1/3 bg-[#F01B23] text-white rounded-3xl flex flex-col items-center justify-center h-full mt-8 md:mt-0 group"
      ...
      <div class="relative w-full h-[400px] overflow-hidden rounded-b-3xl">
        <div class="absolute inset-0 transition-opacity duration-300 group-hover:opacity-0" id="new-product-img-1">
  ...
  <section
    ...
    <!-- Text Column -->
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center text-center h-full px-8" data-aos="fade-up"
      data-aos-delay="300">
