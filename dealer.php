...
<div class="mx-auto px-4 py-12 md:px-8 lg:px-16 xl:px-24 pt-16 md:pt-[100px] mt-16">
  <div class="flex flex-wrap w-full lg:w-1/2">
    <h1 class="text-xl lg:text-3xl md:text-4xl font-extrabold text-[#252525] mb-6">JOSHUA'S MEAT PRODUCTS: AUTHORIZE DEALER/RESELLER APPLICATION FORM</h1>
  </div>
  <div class="mb-8">
  ...
  <div class="md:border-b-2 md:border-gray-200 mb-8 pb-3 overflow-x-auto sm:overflow-hidden">
    <div id="progress-indicator" class="flex items-center lg:gap-2 text-sm lg:text-xl font-semibold text-[#252525] relative">
  ...
  <form id="dealer-form" class="bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8" action="/process_dealer_form.php" method="POST">
    ...
    <div id="step1" class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
      <div class="flex items-center justify-end col-span-1 sm:col-span-2 mb-2">
        <button type="button" id="to-step2" class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">Next &gt;</button>
      </div>
      <div>
        <label for="company_name" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Company Name</label>
      ...
      <div>
        <label for="contact_person" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Contact Person</label>
      ...
      <div>
        <label for="business_email" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Business Email</label>
      ...
      <div>
        <label for="phone_number" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Phone Number</label>
      ...
      <div class="sm:col-span-2">
        <label for="business_address" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Business Address</label>
    ...
    <div id="step2">
      <div class="flex items-center justify-between mb-8">
        <button type="button" id="back-to-step1" class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">&lt; Previous</button>
        <button type="button" id="to-step3" class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">Next &gt;</button>
      </div>
      <div class="mb-4">
        <label for="interested_products" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">What Joshua's Meat Products are you interested in reselling?</label>
      ...
      <div class="mb-4">
        <label for="estimated_quantity" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Estimated quantity of products required per month</label>
      ...
      <div>
        <label for="interest_reason" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Why are you interested in becoming an authorized dealer for Joshua's Meat Products?</label>
    ...
    <div id="step3" class="flex flex-col gap-4 md:gap-6 hidden">
      <div class="flex items-center justify-between mb-2">
        <button type="button" id="back-to-step2" class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">&lt; Previous</button>
      </div>
      <div>
        <label for="additional_info" class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Additional Information</label>
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-4">
        <div class="flex-1">
          <p class="font-bold text-[#252525] mb-1 text-xs sm:text-sm md:text-base">Thank you for your interest in Joshua's Meat Products.<span class="font-normal text-gray-700"> Once you've completed the form, please submit it, and our agent will review your application. If your business qualifies, we will contact you to discuss further opportunities.</span></p>
        </div>
        <div class="flex flex-col items-center gap-4">
          <div class="h-captcha" data-sitekey="fe4037d4-0dc0-4e6a-bed0-05dc18fa7426" data-callback="onCaptchaVerified"></div>
          <button type="submit" id="submit-button" class="w-full md:w-40 h-12 bg-[#F01B23] text-white rounded-lg font-bold text-xs sm:text-sm md:text-base shadow hover:bg-[#F01B23] transition opacity-50 cursor-not-allowed" disabled>Submit</button>
        </div>
      </div>
...
<!-- Confirmation Modal -->
<div id="confirmation-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-[#252525] bg-opacity-40 hidden">
  <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
    ...
    <div class="flex justify-end gap-2">
      ...
      <button id="confirm-submit" class="px-4 py-2 rounded bg-[#F01B23] hover:bg-[#F01B23] text-white font-bold">Confirm</button>
    </div>
  </div>
</div>

<!-- Thank You Modal -->
<div id="thankyou-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-[#252525] bg-opacity-40 hidden">
