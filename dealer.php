...
<body class="bg-gray-50 font-['Poppins']">
    ...
    <div class="mx-auto px-4 py-12 md:px-8 lg:px-16 xl:px-24 pt-16 md:pt-[100px] mt-16">
        <div class="flex flex-wrap w-full lg:w-1/2">
            <h1 class="text-xl lg:text-3xl md:text-4xl font-extrabold text-[#252525] mb-6">JOSHUA'S MEAT PRODUCTS:
                AUTHORIZE DEALER/RESELLER APPLICATION FORM</h1>
        </div>
        <div class="mb-8">
            <h2 class="text-lg lg:text-2xl font-extrabold text-[#252525] mb-2">Become an Authorized Dealer!</h2>
            <p class="text-gray-700 text-sm md:text-lg">Please provide all required details below to qualify your
                business with us. If your company qualifies to become a dealer, our agent will be in contact with you to
                discuss further opportunities. Thank you for your interest in the JMPi Dealer Experience.</p>
        </div>
        <!-- Progress Indicator -->
        <div class="md:border-b-2 md:border-gray-200 mb-8 pb-3 overflow-x-auto sm:overflow-hidden">
            <div id="progress-indicator"
                ...
                <span id="step1-indicator" class="step-label transition-all duration-200 relative">Contact
                    Information</span>
        ...
        <form id="dealer-form" class="bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8" action="/process_dealer_form.php"
            ...
            <div id="step1" class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                <div class="flex items-center justify-end col-span-1 sm:col-span-2 mb-2">
                    <button type="button" id="to-step2"
                        class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">Next &gt;</button>
                </div>
                <div>
                    <label for="company_name"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Company
                        Name</label>
                ...
                <div>
                    <label for="contact_person"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Contact
                        Person</label>
                ...
                <div>
                    <label for="business_email"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Business
                        Email</label>
                    <input type="email" id="business_email" name="business_email"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 sm:px-4 sm:py-3 focus:outline-none focus:ring-2 focus:ring-red-500 text-xs sm:text-sm md:text-base"
                        required>
                    <p id="email-error" class="mt-1 text-xs text-red-500 hidden">Please enter a valid email address
                        (e.g., name@company.com)</p>
                </div>
                <div>
                    <label for="phone_number"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Phone
                        Number</label>
            ...
            <div id="step2" class="hidden">
                <div class="flex items-center justify-between mb-8">
                    <button type="button" id="back-to-step1"
                        class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">&lt; Previous</button>
                    <button type="button" id="to-step3"
                        class="text-xs sm:text-sm md:text-base hover:text-[#F01B23]">Next &gt;</button>
                </div>
                <div class="mb-4">
                    <label for="interested_products"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">What
                        Joshua's Meat Products are you interested in reselling?</label>
                ...
                <div class="mb-4">
                    <label for="estimated_quantity"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Estimated
                        quantity of products required per month</label>
                ...
                <div>
                    <label for="interest_reason"
                        class="block font-bold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-[#252525]">Why are you
                        interested in becoming an authorized dealer for Joshua's Meat Products?</label>
            ...
            <div id="step3" class="flex flex-col gap-4 md:gap-6 hidden">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-4">
                    <div class="flex-1">
                        <p class="font-bold text-[#252525] mb-1 text-xs sm:text-sm md:text-base">
                            Thank you for your interest in Joshua's Meat Products.
                            <span class="font-normal text-gray-700">Once you've completed the form, please submit it,
                                and our agent will review your application. If your business qualifies, we will contact
                                you to discuss further opportunities.</span>
                        </p>
                    </div>
                ...
                <input type="hidden" id="recaptcha_token" name="h-captcha-response">
                <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <p class="text-sm text-gray-600"><strong>Disclaimer:</strong> By submitting this form, you
                        acknowledge that all information provided is accurate and complete. Joshua's Meat Products
                        reserves the right to verify all information provided and may request additional documentation.
                        Incomplete or inaccurate information may result in the rejection of your application.</p>
                </div>
            </div>
    ...
    <div id="thankyou-modal"
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
            ...
            <p class="mb-4 text-gray-700">Your application has been submitted successfully.<br>We appreciate your
                interest in becoming a dealer.</p>
